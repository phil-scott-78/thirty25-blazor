    ...
    return new BlogSiteOptions()
    {
        ...
        [
            new Project("MyLittleContentEngine",
                ...
                "https://github.com/phil-scott-78/MyLittleContentEngine"),
            new Project("MonorailCSS",
                "MonorailCSS is a utility-first CSS library inspired heavily by Tailwind for .NET",
                "https://github.com/monorailcss/MonorailCss.Framework"),
            new Project("Mdazor", "A Markdig extension that lets you embed Blazor components directly in Markdown",
                "https://github.com/phil-scott-78/Mdazor"),
