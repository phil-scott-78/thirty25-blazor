...
namespace Thirty25.Web.BlogServices.Markdown;
    ...
    public partial class GbnfHighlighter
    {
        public static string HighlightGbnf(string gbnfText)
        {
        ...
        private static List<Token> TokenizeGbnf(string text)
        {
            ...
            while (currentPosition < text.Length)
            {
                ...
                var whitespaceMatch = WhitespaceRegex().Match(text.Substring(currentPosition));
